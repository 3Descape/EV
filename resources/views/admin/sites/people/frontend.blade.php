                            ...
                            <tbody>
                                @foreach ($sga as $person)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{route('api_person_delete', $person->id)}}" class="btn btn-danger float-right mx-1"><i class="fa fa-trash-o"></i></a>
                                            <a href="{{route('api_person_edit', $person->id)}}" class="btn btn-warning float-right mx-1"><i class="fa fa-pencil"></i></a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
